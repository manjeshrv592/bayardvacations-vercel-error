      ...
      <section className="py-8 c-md:py-12 c-xl:py-16">
        <Container>
          ...
          <p>
            ...
            lawful purpose, commercial or otherwise, without acknowledgement or
          ...
          <p>
            ...
            Policy:{" "}
            <a href="https://bayardvacations.com/privacy-policy">
              Privacy Policy
            </a>
          ...
          <p>
            ...
            India. Bayard Vacations and yourself irrevocably consent that the
          ...
          <p>
            ...
            arbitration shall be Bangalore, India. The language of the
          ...
          <p>
            Exceptions to Informal Negotiations and Arbitration Restrictions
          </p>
          <p>
          ...
          <h3>23. CANCELLATION POLICY</h3>
          <p>A. After booking if any cancellation 10% charge.</p>
          <p>
            B. 30 days or more days to arrival is at 25% charge from the total
            pax reserved.
          </p>
          <p>
            C. 30 to 15 days to arrival is at 50% charge from the total pax
            reserved.
          </p>
          <p>
            D. 15 days or less prior to arrival is at 75% charge from the total
            pax reserved.
          </p>
          <p>
            E. 3 to 1 Day prior to arrival or same day or No show is 100% charge
            from the total pax reserved.
          </p>
          <h3>24. REFUND POLICY</h3>
          <p>After the cancellation 10 to 15 working days for refund policy.</p>
          <h3>25. CONTACT US</h3>
          <p>
